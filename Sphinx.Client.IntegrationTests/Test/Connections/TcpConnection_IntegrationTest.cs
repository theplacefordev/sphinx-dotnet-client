...
namespace Sphinx.Client.IntegrationTests.Test.Connections
{
	...
	/// to contain all TcpConnection Integration Tests
	///</summary>
	[TestClass]
	public class TcpConnection_IntegrationTest
	{
		///<summary>
        ...
        {
        	using (var connection = new TcpConnection(TestSettings.Default.Host, TestSettings.Default.Port))
			{
        		connection.Open();
